                ...
                <v-dialog v-model="StatusDialog" max-width="290">
                        <v-card>
                          ...
                          <v-card-actions>
                            ...
                            <v-btn color="green darken-1" text @click="setStatus()">Disagree</v-btn>

                            <v-btn color="green darken-1" text @click="StatusDialog = false">Agree</v-btn>
                          </v-card-actions>
                        </v-card>
                      </v-dialog>
...
export default {
  ...
  methods: {
    ...
    async setStatus(){
      let status = this.ChoosenItems.status == 0 ? 1 : 0;
