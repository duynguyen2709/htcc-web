    ...
    <v-form>
      <v-container py-0>
        <v-layout wrap>
          ...
          <v-flex xs12 md6>
            <v-text-field v-model="InlineUser.firstname" label="First Name" class="purple-input" />
          </v-flex>
          <v-flex xs12 md6>
            <v-text-field v-model="InlineUser.lastname" label="Last Name" class="purple-input" />
          </v-flex>
          <v-flex xs12 md12>
            <v-text-field
              label="Phone"
