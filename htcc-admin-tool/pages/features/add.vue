  ...
  <v-flex xs12>
    ...
    <material-card color="primary" elevation="12" title="Thêm gói chức năng">
      ...
      <v-form ref="form" @submit.prevent v-model="isValid">
        <v-card-text>
          <div class="wrapper">
            ...
            <div class="wrapper-input">
              <v-text-field label="Mã gói" class="green-input input-file" v-model="idCombo"
        ...
        <v-card-actions>
          <v-btn :loading="isLoadingBtnSave"
            :disabled="!isValid"
            color="green" class="mx-auto d-block white--text" @click="ConfirmDialog = true">Thêm</v-btn>
        </v-card-actions>
      </v-form>
    </material-card>
    ...
    <v-dialog v-model="ConfirmDialog" max-width="290">
      <v-card>
        ...
        <v-card-text class="mt-2">Bạn có chắc muốn thêm gói chức năng này?</v-card-text>
