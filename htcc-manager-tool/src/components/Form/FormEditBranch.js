...
import {checkValidEmail, checkValidNumber, checkValidPhoneNumber,} from '../../utils/validate';
                    ...
                    <Col md="6">
                        <FormGroup>
                            ...
                            <Input
                                ...
                                invalid={touch.phoneNumber && !checkValidPhoneNumber(value.phoneNumber)}
                            />
                            <FormFeedback invalid={'true'}>
                    ...
                    <Col md="12">
                        <FormGroup>
                            ...
                            <Input
                                ...
                                invalid={touch.maxAllowDistance && !checkValidNumber(value.maxAllowDistance)}
                            />
                            <FormFeedback invalid={'true'}>
